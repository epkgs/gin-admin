...
func NewCaptcha(app types.AppContext) *Captcha {
	return &Captcha{
		app:        app,
		CaptchaSVC: service.NewCaptcha(app),
	}
}
...
// @Success 200 {object} dto.Result[dto.Captcha]
...
// @Param request query dto.CaptchaImageReq false "query params"
// @Produce image/png
// @Success 200 "Captcha image"
// @Failure 404 {object} dto.Result[any]
// @Router /api/v1/captcha/image [get]
func (a *Captcha) Image(c *gin.Context) {
	ctx := c.Request.Context()
	var req dto.CaptchaImageReq
