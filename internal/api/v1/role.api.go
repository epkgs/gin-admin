...
// @Param request query dto.RoleListReq false "query params"
// @Success 200 {object} dto.ResultList[model.Role]
// @Failure 401 {object} dto.Result[any]
// @Failure 500 {object} dto.Result[any]
// @Router /api/v1/roles [get]
func (a *Role) Query(c *gin.Context) {
	ctx := c.Request.Context()
	var params dto.RoleListReq
...
// @Success 200 {object} dto.Result[model.Role]
// @Failure 401 {object} dto.Result[any]
// @Failure 500 {object} dto.Result[any]
...
// @Param body body dto.RoleCreateReq true "Request body"
// @Success 200 {object} dto.Result[model.Role]
...
// @Param id path string true "unique id"
// @Param body body dto.RoleUpdateReq true "Request body"
