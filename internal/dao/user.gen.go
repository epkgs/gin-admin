...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.Roles = userManyToManyRoles{
		...
		Menus: struct {
			...
			RelationField: field.NewRelation("Roles.Menus", "model.Menus"),
			Children: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("Roles.Menus.Children", "model.Menus"),
			},
			Roles: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("Roles.Menus.Roles", "model.Roles"),
			},
		},
		Users: struct {
			field.RelationField
			...
			RelationField: field.NewRelation("Roles.Users", "model.Users"),
			Roles: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("Roles.Users.Roles", "model.Roles"),
			},
		},
	}
...
func (a userManyToManyRolesTx) Find() (result []*model.Roles, err error) {
	return result, a.tx.Find(&result)
}

func (a userManyToManyRolesTx) Append(values ...*model.Roles) (err error) {
...
func (a userManyToManyRolesTx) Replace(values ...*model.Roles) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a userManyToManyRolesTx) Delete(values ...*model.Roles) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
type IUserDo interface {
	...
	Get(id string) (result *model.User, err error)
}

// Get data by ID
//
// where("id=@id")
func (u userDo) Get(id string) (result *model.User, err error) {
