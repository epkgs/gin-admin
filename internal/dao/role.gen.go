...
func newRole(db *gorm.DB, opts ...gen.DOOption) role {
	...
	_role.Menus = roleManyToManyMenus{
		...
		RelationField: field.NewRelation("Menus", "model.Menus"),
		Children: struct {
			field.RelationField
		}{
			RelationField: field.NewRelation("Menus.Children", "model.Menus"),
		},
		Roles: struct {
			field.RelationField
			Menus struct {
			...
			Menus: struct {
				...
				RelationField: field.NewRelation("Menus.Roles.Menus", "model.Menus"),
			},
			Users: struct {
				field.RelationField
				Roles struct {
				...
				RelationField: field.NewRelation("Menus.Roles.Users", "model.Users"),
				Roles: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("Menus.Roles.Users.Roles", "model.Roles"),
				},
			},
		},
	}
...
func (a roleManyToManyMenusTx) Find() (result []*model.Menus, err error) {
	return result, a.tx.Find(&result)
}

func (a roleManyToManyMenusTx) Append(values ...*model.Menus) (err error) {
...
func (a roleManyToManyMenusTx) Replace(values ...*model.Menus) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a roleManyToManyMenusTx) Delete(values ...*model.Menus) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a roleManyToManyUsersTx) Find() (result []*model.Users, err error) {
	return result, a.tx.Find(&result)
}

func (a roleManyToManyUsersTx) Append(values ...*model.Users) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a roleManyToManyUsersTx) Replace(values ...*model.Users) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a roleManyToManyUsersTx) Delete(values ...*model.Users) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
type IRoleDo interface {
	...
	Get(id string) (result *model.Role, err error)
}

// Get data by ID
//
// where("id=@id")
func (r roleDo) Get(id string) (result *model.Role, err error) {
