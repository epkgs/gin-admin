...
func newMenu(db *gorm.DB, opts ...gen.DOOption) menu {
	...
	_menu.Children = menuHasManyChildren{
		...
		RelationField: field.NewRelation("Children", "model.Menus"),
		Children: struct {
			field.RelationField
		}{
			RelationField: field.NewRelation("Children.Children", "model.Menus"),
		},
		Roles: struct {
			field.RelationField
			Menus struct {
			...
			Menus: struct {
				...
				RelationField: field.NewRelation("Children.Roles.Menus", "model.Menus"),
			},
			Users: struct {
				field.RelationField
				Roles struct {
				...
				RelationField: field.NewRelation("Children.Roles.Users", "model.Users"),
				Roles: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("Children.Roles.Users.Roles", "model.Roles"),
				},
			},
		},
	}
...
func (a menuHasManyChildrenTx) Find() (result []*model.Menus, err error) {
	return result, a.tx.Find(&result)
}

func (a menuHasManyChildrenTx) Append(values ...*model.Menus) (err error) {
...
func (a menuHasManyChildrenTx) Replace(values ...*model.Menus) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a menuHasManyChildrenTx) Delete(values ...*model.Menus) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
type IMenuDo interface {
	...
	Get(id string) (result *model.Menu, err error)
}

// Get data by ID
//
// where("id=@id")
func (m menuDo) Get(id string) (result *model.Menu, err error) {
