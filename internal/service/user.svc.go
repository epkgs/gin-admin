...
func (a *User) List(ctx context.Context, req dto.UserListReq) (*dto.List[*model.User], error) {
...
func (a *User) Create(ctx context.Context, req *dto.UserCreateReq) (*model.User, error) {
