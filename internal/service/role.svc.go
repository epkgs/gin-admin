...
func (a *Role) List(ctx context.Context, req dto.RoleListReq) (*dto.List[*model.Role], error) {
...
func (a *Role) Create(ctx context.Context, req dto.RoleCreateReq) (*model.Role, error) {
	r := a.q.Role
