...
// @Param body body dto.Login true "Request body"
// @Success 200 {object} dto.Result[dto.LoginToken]
...
// @Success 200 {object} dto.Result[po.User]
// @Failure 401 {object} dto.Result[any]
// @Failure 500 {object} dto.Result[any]
...
// @Param body body dto.AuthUpdatePasswordReq true "Request body"
// @Success 200 {object} dto.Result[any]
// @Failure 400 {object} dto.Result[any]
// @Failure 401 {object} dto.Result[any]
// @Failure 500 {object} dto.Result[any]
...
func (a *Auth) UpdatePassword(c *gin.Context) {
	ctx := c.Request.Context()
	item := new(dto.AuthUpdatePasswordReq)
	if err := c.ShouldBindJSON(item); err != nil {
		response.Error(c, err)
		return
	}
...
// @Success 200 {object} dto.Result[po.Menus]
// @Failure 401 {object} dto.Result[any]
// @Failure 500 {object} dto.Result[any]
...
// @Param body body dto.AuthUpdateUserReq true "Request body"
// @Success 200 {object} dto.Result[any]
// @Failure 400 {object} dto.Result[any]
// @Failure 401 {object} dto.Result[any]
// @Failure 500 {object} dto.Result[any]
...
func (a *Auth) UpdateUser(c *gin.Context) {
	ctx := c.Request.Context()
	item := new(dto.AuthUpdateUserReq)
	if err := c.ShouldBindJSON(item); err != nil {
		response.Error(c, err)
		return
	}
