...
func (a *Auth) Login(ctx context.Context, req *dto.Login) (*dto.LoginToken, error) {
	...
	if user.Status != po.UserStatus_Activated {
...
// Get user info
func (a *Auth) GetUserInfo(ctx context.Context) (*po.User, error) {
...
func (a *Auth) QueryMenus(ctx context.Context) (po.Menus, error) {
	req := dto.MenuListReq{
